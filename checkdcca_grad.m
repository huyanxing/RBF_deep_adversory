...
%W2 = W2(:);
[cost,grad] = Rbf_autoencoderCost(theta, visibleSize, hiddenSize, sigmavalue,lambda, sparsityParam, beta, data);

numGrad = computeNumericalGradient( @(x)Rbf_autoencoderCost(x, visibleSize, hiddenSize, sigmavalue, lambda, sparsityParam,...
                                                         beta, data), theta);
%%
